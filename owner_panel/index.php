...
<head>
    ...
    <title>SARI PRIMARY SCHOOL - owner</title>
</head>
<body>
    <div class="header">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">SARI PRIMARY SCHOOL
</a>
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.05);">
    ...
    <a class="text-body" target="_blank" href="#">Sari Primary School</a>
  </div>
  <!-- Copyright -->
</footer>
